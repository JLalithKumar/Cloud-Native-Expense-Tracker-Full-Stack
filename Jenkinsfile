...
stages {
    ...
    stage('Build Backend Docker Image') {
        steps {
            bat 'docker build -t lalithkumarj/expense-tracker:v18 .'
        }
    }
    ...
    stage('Push Backend Docker Image') {
        steps {
            ...
            bat 'docker push lalithkumarj/expense-tracker:v18'
        }
    }
    ...
    stage('Build Frontend Docker Image') {
        steps {
            dir('expense-tracker-ui') {
                bat 'docker build -t lalithkumarj/expense-tracker-ui:v18 .'
            }
        }
    }
    ...
    stage('Push Frontend Docker Image') {
        steps {
            bat 'docker push lalithkumarj/expense-tracker-ui:v18'
        }
    }
